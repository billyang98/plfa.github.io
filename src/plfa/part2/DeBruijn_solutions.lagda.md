...
```
module plfa.part2.DeBruijn_solutions where
```
...
#### Exercise `mul-example` (recommended) ****HOMEWORK****
...
_ : eval (gas 100) (mul · two · two) ≡
    steps
    (
      (μ (ƛ (ƛ case (` (S Z)) `zero (plus · # 1 · (# 3 · # 0 · # 1)))))
      · `suc (`suc `zero)
      · `suc (`suc `zero)
      —→⟨  ξ-·₁ (ξ-·₁ β-μ) ⟩
       ((ƛ (ƛ case (` (S Z)) `zero (plus · # 1 ·
         ((μ (ƛ (ƛ case (` (S Z)) `zero
           (plus · # 1 · (# 3 · # 0 · # 1)))))
           · # 0 · # 1)))))
       · `suc (`suc `zero)
   ...
   —→⟨ β-suc (V-suc V-zero) ⟩
      ...
      ((μ (ƛ (ƛ case (` (S Z)) `zero (plus · # 1 · (# 3 · # 0 · # 1)))))
       ...
       · `suc (`suc `zero))))
   —→⟨ (ξ-·₁ (ξ-·₁ β-μ)) ⟩
     (((ƛ (ƛ case (# 1) (# 0) (`suc ((μ (ƛ (ƛ case (# 1) (# 0) (`suc (# 3 · # 0 · # 1)))))
       · # 0 · # 1)))))
     · `suc (`suc `zero)
     ·
     ((μ (ƛ (ƛ case (` (S Z)) `zero (plus · # 1 · (# 3 · # 0 · # 1)))))
  ...
  —→⟨ ξ-·₂ V-ƛ (ξ-·₁ (ξ-·₁ β-μ)) ⟩
    ((ƛ
      ...
      (`suc
       ((μ (ƛ (ƛ case (# 1) (# 0) (`suc (# 3 · # 0 · # 1))))) · # 0 ·
        # 1)))
     ·
     (((ƛ (ƛ case (` (S Z)) `zero (plus · # 1 · ((μ (ƛ (ƛ case (` (S Z)) `zero (plus · # 1 · (# 3 · # 0 · # 1)))))
          · # 0 · # 1)))))
      · `suc `zero
      · `suc (`suc `zero)))
   ...
   —→⟨ ξ-·₂ V-ƛ (β-suc (V-suc V-zero)) ⟩
     ...
     ·
     ((`suc
       ((μ (ƛ (ƛ case (# 1) (# 0) (`suc (# 3 · # 0 · # 1))))) ·  `suc `zero ·
        `zero))))
  —→⟨ ξ-·₂ V-ƛ (ξ-suc (ξ-·₁ (ξ-·₁ β-μ))) ⟩
    ((ƛ
      case (`suc (`suc `zero)) (# 0)
